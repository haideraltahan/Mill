...
Mill is in **alpha** — two benchmarks ship today. Add your own with [custom tasks](#registering-custom-tasks).

| Benchmark | Task name(s) | Modality | Output type | Default n-shot | Metric |
|---|---|---|---|---|---|
| `mmlu` | `mmlu_<subject>` (57 subjects) | Text | `LOGPROBS` | 5 | `acc` |
| `mmlu_pro` | `mmlu_pro` | Text | `GENERATIVE` (chain-of-thought) | 0 | `mmlu_pro_acc` |
