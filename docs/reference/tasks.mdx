...
| `esc50` | `esc50`, `esc50_generative` | Audio (\+ Text) | zero-shot / generative | 0 | `acc` / `esc50_gen_acc` |
| `urbansound8k` | `urbansound8k`, `urbansound8k_generative` | Audio (\+ Text) | zero-shot / generative | 0 | `acc` / `urbansound8k_gen_acc` |
